...
test.describe("Klangk E2E", () => {
  ...
  test("paste shortcut is ignored when terminal isn't focused", async ({
    ...
    try {
      ...
      // Owner has 4 tabs (Terminal, Files, Sharing, Settings).
  ...
  test("terminal works after tab switching", async ({ page, request }) => {
    ...
    try {
      ...
      // Workspace owner has 4 tabs: Terminal, Files, Sharing, Settings.
      // Each tab is width/4 wide; use center of each tab.
      const tabWidth = width / 4;
