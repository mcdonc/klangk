...
class TestMainCLI:
    ...
    def test_terminals_with_output_before_windows(
        self, logged_in_cfg, monkeypatch, reset_env
    ):
        """Terminal output arrives before terminal_windows — still works."""
        from klangk_backend.cli import main
    ...
    def test_share_with_output_before_windows(
        self, logged_in_cfg, monkeypatch, reset_env
    ):
        from klangk_backend.cli import main
    ...
    def test_unshare_with_output_before_windows(
        self, logged_in_cfg, monkeypatch, reset_env
    ):
        from klangk_backend.cli import main
