...
- `KLANGKD_PORT` (default unset): **Browser access point** — the proxy serves UI, API, WebSocket, and proxies hosted app URLs directly to container ports. Unset ⇒ headless mode (no browser listener). Suggested `8997`.
