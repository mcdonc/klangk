...
| `manage-events`          | `/events`           | Read the audit histories: container start/stop (`GET /events/containers`) and the identity/privilege stream (`GET /events/audit`, #3205) — read-only audit            |
