...
| own-window management (`terminal_new/select/close/rename/list_windows`) | `code-in-isolation`                                 | `/workspaces/{id}` | coders, collaborators             | live, per message (#3022); plain code-less refusal for join-only members and spectators             |
