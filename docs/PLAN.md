...
- **Rename PLAN.md to ARCHITECTURE.md and move to repo root**: The project overview and architecture docs are in `docs/PLAN.md` but should be at the repo root as `ARCHITECTURE.md` for discoverability.
