...
# declares the only container-scope keys (the GitHub/GitLab device-flow
# shorthands, the Gitea PKCE shorthand pair, and the multi-provider
# device-flow map, #432 / #3405).
EXPECTED_CONTAINER_ENV_KEYS = [
    "KLANGKWS_FEATURE_GITHUB_OAUTH_CLIENT_ID",
    "KLANGKWS_FEATURE_GITLAB_OAUTH_CLIENT_ID",
    "KLANGKWS_FEATURE_GITEA_OAUTH_CLIENT_ID",
...
class TestManifestContract:
    ...
    def test_every_config_key_has_valid_shape_and_scope(self, tmp_path, monkeypatch):
        ...
        assert all_keys == {
            ...
            "KLANGKWS_FEATURE_GITEA_OAUTH_CLIENT_ID": "container",
            "KLANGKWS_FEATURE_GITEA_OAUTH_REDIRECT_URI": "container",
