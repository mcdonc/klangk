...
const _defaultConfigAsset =
    'packages/klangk_feature_soliplex/assets/soliplex_config.json';

/// Read the bundled `default_url` from the feature asset. Returns null if the
...
/// Process-wide registry of Soliplex servers. The feature defaults to this one;
      ...
      await for (final outcome in agui.runAgent(
        ...
        if (outcome is sox.DecodedEvent) {
          ...
          if (event is sox.TextMessageContentEvent) {
            ...
            // BETWEEN chunks (KLANGKD_BRIDGE_TIMEOUT_SECONDS, default 30s); a
