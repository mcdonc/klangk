...
/// Loads the `default` server's base URL (the bundled feature asset in
...
/// Registry of the Soliplex servers this feature can reach, keyed by the name
...
/// [addServer] entirely feature-side, so klangk never needs to know about more
...
class SoliplexServerRegistry {
  ...
  /// Loads the `default` server URL (bundled feature asset in production).
  ...
  /// the feature constructor's auth-state refresh racing a tool handler — all
